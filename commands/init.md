...
Generate a `.codex-toolkit.md` configuration file in your project root. This file customizes how all `/codex-toolkit:*` commands behave for this specific project.
...
These override the built-in defaults for all `/codex-toolkit:*` commands in this project.
...
```markdown
## Config created: .codex-toolkit.md
...
- **Run** `/audit-mini` to test with your new settings
- **Commit** `.codex-toolkit.md` to share settings with your team (if using `--scope project`)
